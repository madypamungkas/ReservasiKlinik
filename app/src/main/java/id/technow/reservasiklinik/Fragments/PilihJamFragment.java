...
public class PilihJamFragment extends BottomSheetDialogFragment implements View.OnClickListener {

    public PilihJamFragment() {
    ...
    public void setupDialog(Dialog dialog, int style) {
        ...
        View fragmentView = LayoutInflater.from(getContext()).inflate(R.layout.fragment_pilih_jam, null);
