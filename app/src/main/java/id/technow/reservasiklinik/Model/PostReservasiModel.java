...
public class PostReservasiModel {
    @SerializedName("id")
    @Expose
    private String id;
    ...
    public PostReservasiModel(String id, String kode, String poli_id, String antrian, String jam, String counter, String pasien_id, String keluhan, String status, String tanggal, String kekhawatiran, String riwayat_penyakit_menahun, String upaya_pengobatan, String created_at, String updated_at, String status_updated_by) {
        this.id = id;
        this.kode = kode;
